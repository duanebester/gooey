...
// imported lazily inside the helper functions to avoid a forward-edge
// import cycle at the top level.
...
fn computeSizing(style: UniformListStyle) Sizing {
...
fn computePadding(style: UniformListStyle) Padding {
