// Point cloud rendering shader - renders instanced SDF circles
// Optimized for scatter plots and data markers with thousands of points
// Port of gooey/src/platform/mac/metal/point_cloud_pipeline.zig
...
@group(0) @binding(0) var<storage, read> vertices: array<PointVertex>;
@group(0) @binding(1) var<uniform> uniforms: PointCloudUniforms;
