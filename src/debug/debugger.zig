...
pub const Debugger = struct {
    ...
    atlas_upload_ns: u64 = 0,
    frame_time_ns: u64 = 0,
    frame_history: [FRAME_HISTORY_SIZE]FrameSnapshot = @splat(.{}),
    ...
    fmt_buffers: [FMT_BUFFER_COUNT][FMT_BUFFER_SIZE]u8 = @splat(@splat(0)),
...
fn renderTextSimple(
    ...
    _ = text_render.renderText(s, text_system, content, x, baseline_y, scale_factor, color, metrics.point_size, &opts) catch return;
}
